...
define( 'MLM_VERSION', '0.14.26' );
define( 'MLM_FILE', __FILE__ );
define( 'MLM_DIR', plugin_dir_path( __FILE__ ) );
define( 'MLM_URL', plugin_dir_url( __FILE__ ) );

require_once MLM_DIR . 'includes/class-mlm-plugin-v9.php';
require_once MLM_DIR . 'includes/class-mlm-github-updater.php';

register_activation_hook( __FILE__, array( 'MLM_Plugin_V9', 'activate' ) );
MLM_Plugin_V9::instance();
