(function () {
  ...
  new window.APlayer({ container: container, autoplay: false, theme: '#2271b1', preload: 'none', mutex: true, lrcType: audio.some(function (item) { return item.lrc; }) ? 1 : 0, listFolded: false, listMaxHeight: '480px', audio: audio });
}());
